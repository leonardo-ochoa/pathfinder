...
public class GraphTestDriver {
    ...
    private final Map<String, GraphADT<String, String>> graphs = new HashMap<String, GraphADT<String, String>>();
    ...
    private void createGraph(String graphName) {
        ...
        graphs.put(graphName, new GraphADT<String, String>());
    ...
    private void addNode(String graphName, String nodeName) {
        // TODO Insert your code here.
        GraphADT<String, String> temp = graphs.get(graphName);
    ...
    private void addEdge(String graphName, String parentName, String childName,
        ...
        // TODO Insert your code here.
        GraphADT<String, String> temp = graphs.get(graphName);
        temp.addEdges(parentName, childName, edgeLabel);
    ...
    private void listNodes(String graphName) {
        // TODO Insert your code here.
        GraphADT<String, String> temp = graphs.get(graphName);
        Set<String> list = order(temp.getNodes());
        String print = "";
        for(String s: list){
            print += " " + s;
        }
    ...
    private void listChildren(String graphName, String parentName) {
        ...
        GraphADT<String, String> temp = graphs.get(graphName);
        String print = "";
        Set<String> children = order(temp.childrenOfParent(parentName));
        for (String child: children) {
            Set<String> edges = order(temp.getEdges(parentName, child));
            for(String e: edges){
                print += " " + child + "(" + e + ")";
            }
        }
