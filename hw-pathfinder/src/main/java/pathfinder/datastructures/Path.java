...
public class Path<T> implements Iterable<Path<T>.Segment> {
    ...
    public Path(T start) { //////////////////////////////////////////////////////////////////////
        this.start = start;
        this.cost = 0;
        this.path = new ArrayList<Path<T>.Segment>();
        checkRep();
    }
     ...
     * segmentCost}.
     *
     * @param newEnd      The objet being added at the end of the segment being appended to this path
     ...
     * are created as part of larger paths by calling Path#extend(objects, double).
     */
